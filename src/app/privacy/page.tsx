...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen max-w-2xl mx-auto px-6 py-10">
      ...
      <p className="text-xs text-[#937b7c] mb-8">GroomAI - Your live AI makeup coach</p>
      ...
      <section className="space-y-4 text-sm text-[#ddc9c5]">
        <div>
          ...
          <p>GroomAI processes every selfie and every live mirror frame 100% inside your browser, on your device. Your photos and camera video are never uploaded, stored, or seen by our servers. Close the tab and they are gone.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>Supabase (anonymous event storage), Whop (checkout), and retailer links (Sephora, Amazon) each operate under their own privacy policies once you leave GroomAI.</p>
        </div>
        <div>
