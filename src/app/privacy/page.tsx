...
export const metadata: Metadata = { title: 'Privacy Policy - GroomAI' };
...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen max-w-2xl mx-auto px-6 py-10">
      ...
      <p className="text-xs text-[#937b7c] mb-8">GroomAI - Your live AI grooming coach</p>
      ...
      <section className="space-y-4 text-sm text-[#ddc9c5]">
        <div>
          ...
          <p>GroomAI processes every selfie 100% inside your browser, on your device. Your photos are never uploaded, stored, or seen by our servers. Close the tab and they are gone.</p>
        </div>
        <div>
          <h2 className="font-bold text-[#e8b4bc] mb-1">2. What we do collect</h2>
          <p>We collect anonymous usage events (for example: a beard style tried, a barber card downloaded) to understand which features help you. These events contain no name, no email, and no photo data.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>Supabase (anonymous event storage) and Whop (checkout) each operate under their own privacy policies once you leave GroomAI.</p>
        </div>
        <div>
          <h2 className="font-bold text-[#e8b4bc] mb-1">5. Your control</h2>
          <p>No account is required. Clearing your browser cookies resets GroomAI to a fresh, free session at any time.</p>
        </div>
        <div>
